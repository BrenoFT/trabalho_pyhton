...
def criar_tabela():
  conn = sqlite3.connect('banco_dado.db')
  cur = conn.cursor()
  cur.execute('''
...
def fazer_login():
  ...
  cur.execute(
    "SELECT * FROM usuarios WHERE usuario = ? AND email = ? AND senha = ?",
    (usuario, email, senha))
...
def abrir_janela_principal():
  ...
  from view import inserirProduto, atualizarProduto, exibirProduto, deletarProduto
  ...
  label_nome = tk.Label(frame_baixo,
                        text="Nome",
                        anchor=NW,
                        font=('Ivy 10 bold'),
                        bg=co1,
  ...
  label_tipo = tk.Label(frame_baixo,
                        text="Tipo",
                        anchor=NW,
                        font=('Ivy 10 bold'),
                        bg=co1,
  ...
  entry_tipo = tk.Entry(frame_baixo, width=45, justify="left", relief='solid')
  entry_tipo.place(x=10, y=100)

  label_codigo = tk.Label(frame_baixo,
                          text="Codigo",
                          anchor=NW,
                          font=('Ivy 10 bold'),
                          bg=co1,
                          fg=co4,
                          relief='flat')
  label_codigo.place(x=10, y=130)

  entry_codigo = tk.Entry(frame_baixo,
                          width=45,
                          justify="left",
                          relief='solid')
  entry_codigo.place(x=10, y=160)

  label_estoque = tk.Label(frame_baixo,
                           text="Estoque",
                           anchor=NW,
                           font=('Ivy 10 bold'),
                           bg=co1,
  ...
  entry_estoque = tk.Entry(frame_baixo,
                           width=45,
                           justify="left",
                           relief='solid')
  entry_estoque.place(x=15, y=220)
  ...
  def inserir():
    ...
    lista = [nome, tipo, codigo, estoque]
  ...
  def exibir():
    ...
    tabela_head = ['ID', 'nome', 'tipo', 'codigo', 'estoque']

    tree = ttk.Treeview(frame_direita,
                        selectmode="extended",
                        columns=tabela_head,
                        show="headings")
  ...
  def atualizar():
    ...
    try:
      ...
      entry_tipo.insert(0, tree_lista[2])
      entry_codigo.insert(0, tree_lista[3])
      entry_estoque.insert(0, tree_lista[4])
      ...
      def update():
        ...
        lista = [nome, tipo, codigo, estoque, valor_id]
      ...
      button_confirmar = tk.Button(frame_baixo,
                                   command=update,
                                   text="Confirmar",
                                   width=10,
                                   font=('Ivy 7 bold'),
      ...
      messagebox.showerror('Erro',
                           'Selecione um dos dados na tabela para atualizar')
  ...
  button_inserir = tk.Button(frame_baixo,
                             command=inserir,
                             text="Inserir",
                             width=10,
                             font=('Ivy 9 bold'),
  ...
  button_atualaizar = tk.Button(frame_baixo,
                                command=atualizar,
                                text="Atualizar",
                                width=10,
                                font=('Ivy 9 bold'),
  ...
  button_deletar = tk.Button(frame_baixo,
                             command=deletar,
                             text="Deletar",
                             width=10,
                             font=('Ivy 9 bold'),
  ...
  button_exibir = tk.Button(frame_baixo,
                            text="Exibir",
                            width=10,
                            font=('Ivy 9 bold'),
                            bg=co3,
...
def abrir_tela_cadastro():
  ...
  entry_email_cadastro = tk.Entry(janela_cadastro)
  entry_email_cadastro.pack()
  ...
  button_cadastrar = tk.Button(
    janela_cadastro,
    text="Cadastrar",
    command=lambda: cadastrar_usuario(entry_usuario_cadastro.get(
    ), entry_email_cadastro.get(), entry_senha_cadastro.get()))
...
button_cadastro = tk.Button(janela_login,
                            text="Cadastro",
